...
def create_data_loader(
    ...
    # Adjust `persistent_workers` and `prefetch_factor` based on `num_workers`
    persistent_workers = num_workers > 0
    prefetch_factor = None if num_workers == 0 else prefetch_factor  # Set to None if no workers
    ...
    return data.DataLoader(
        ...
        multiprocessing_context="fork" if num_workers != 0 else None,  # Only use "fork" with multi-workers
    )
